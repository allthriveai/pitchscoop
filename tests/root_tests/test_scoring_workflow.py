...
def test_scoring_workflow():
    ...
    try:
        from api.domains.shared.infrastructure.langchain_config import PitchScoreOutput, get_pitch_analysis_chains
    ...
    try:
        from api.domains.shared.value_objects.llm_request import get_prompt_template
